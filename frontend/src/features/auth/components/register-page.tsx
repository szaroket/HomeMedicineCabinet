...
export function RegisterPage() {
  return (
    <div className="flex min-h-screen flex-col bg-slate-900">
      <div className="flex flex-1 items-start justify-center pt-16 sm:pt-24">
        <div className="w-full max-w-md rounded-lg border border-slate-700 bg-slate-800 p-8 shadow-xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-center text-sm text-slate-400">
              Kontroluj stan swojej apteczki — terminy ważności, zapasy i
              aktywne leki, zanim zabraknie ich w połowie kuracji.
            </p>
          </div>
