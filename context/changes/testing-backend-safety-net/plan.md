...
- [x] 3.1 Harness smoke passes (`pytest tests/integration/test_harness_smoke.py`) — 49530dd
- [x] 3.2 Isolation holds under random order across repeated runs — 49530dd
- [x] 3.3 CI invocation still green and DB-free — 49530dd
- [x] 3.4 Linting passes (`ruff check tests/integration`) — 49530dd
- [x] 3.5 Type checking passes (`pyright`) — 49530dd

#### Manual

- [x] 3.6 Same-session seam works; rows gone after teardown — 49530dd
- [x] 3.7 `act_as` switches identity within a single test — 49530dd

### Phase 4: Risk #1 + #4 integration (read / membership)

#### Automated

- [x] 4.1 Read/membership tests pass (list_entries + filters) — 2abc53f
- [x] 4.2 Full integration tier green and order-independent — 2abc53f
- [x] 4.3 CI invocation still green and DB-free — 2abc53f
- [x] 4.4 Linting passes (`ruff check tests/integration`) — 2abc53f
- [x] 4.5 Type checking passes (`pyright`) — 2abc53f

#### Manual

- [x] 4.6 Deleting a WHERE clause turns a membership test red — 2abc53f
- [x] 4.7 `to_tsquery` search matches the seeded `search_vector` — 2abc53f

### Phase 5: Risk #5 + #6 residual integration (ownership / usage)

#### Automated

- [x] 5.1 Ownership + usage tests pass — 997738b
- [x] 5.2 Full integration tier green and order-independent — 997738b
- [x] 5.3 CI invocation still green and DB-free — 997738b
- [x] 5.4 Linting passes (`ruff check tests/integration`) — 997738b
- [x] 5.5 Type checking passes (`pyright`) — 997738b

#### Manual

- [x] 5.6 Dropping the `user_id` predicate turns an ownership test red — 997738b
- [x] 5.7 Tweaking `_sufficiency_clauses` turns a parity assertion red — 997738b
- [x] 5.8 Cookbook lines appended to test-plan §6.6 — 997738b
